...
public class PlayerPlugin implements IGamePluginService {
    ...
    public void start(GameData gameData, World world) {
        ...
        createPlayerNinja(gameData, world);

        }

        private Entity createPlayerNinja(GameData gameData, World world){

            playerNinja = new Player();
            ...
            playerNinja.setX(gameData.getDisplayHeight() / 2);
            playerNinja.setY(gameData.getDisplayWidth() / 2);
            playerNinja.add(new LifePart(5));
        ...
        public void stop (GameData gameData, World world){
            // Remove entities
            world.removeEntity(playerNinja);
        }
